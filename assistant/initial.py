...
STRINGS = {
    1: """ **Thanks for Deploying Yxzn Ubot!**

• Here, are the Some Basic stuff from, where you can Know, about its Usage.""",
    2: """🎉** About Yxzn Ubot**

 Yxzn Ubot is Pluggable and powerful Telethon and Pyrogram Userbot, made in Python from Scratch. It is Aimed to Increase Security along with Addition of Other Useful Features.

❣ Bot by **@rChoiHyunWook**""",
    3: """**💡• FAQs •**
